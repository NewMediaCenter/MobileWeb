...
public class SakaiForumParser {

	public List<SakaiForum> parseForums(String json) {
...
//                item.setDescription(description);
    ...
    public List<SakaiForumMessage> parseForumMessages(String json, String topicTitle, boolean needAll) {
    	...
    	try {
            ...
            for (int i = 0; i < itemArray.size(); i++) {
            	...
            	if(!inReplyTo.equals("null") && !needAll) {
            		continue;
            	}
...
//                item.setRole(messageAuthorRole);
    ...
    public List<SakaiForumMessage> parseForumMessageDetails(String json, String messageId, String messageTitle, boolean needAll) {
		List<SakaiForumMessage> messages = new ArrayList<SakaiForumMessage>();
    	try {
            JSONObject jsonObj = (JSONObject) JSONSerializer.toJSON(json);
            JSONArray itemArray = jsonObj.getJSONArray("forum_message_collection");
