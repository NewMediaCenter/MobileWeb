...
<kme:page title="Details" id="roster_details">
    ...
    <ul data-role="listview" data-theme="c"  data-dividertheme="b"  data-inset="true">
			<c:forEach items="${roster}" var="item" varStatus="status">
				<li>
		        <div class="ui-grid-a">
		          <div class="ui-block-a" style="width:40%"> <img src="http://localhost:9090/direct/profile/${item.displayID}/image/thumb?sakai.session=${sessionId}" width="70" height="70" alt="image"></div>
