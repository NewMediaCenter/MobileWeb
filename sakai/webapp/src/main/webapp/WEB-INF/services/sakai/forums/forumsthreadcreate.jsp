...
$(function(){
	$("#jQForumThreadForm").submit(function(){
		...
		$.post("${pageContext.request.contextPath}/sakaiforumsmessages", { 'title': title, 'body': body, 'topicId': topicId, 'forumId': forumId },
				   function(data) {
				     //alert("Posted " + data);
				     $.unblockUI();
...
<div data-role="page" id="">
  ...
  <div data-role="content" style="padding-top:0px" >
    <form id="jQForumThreadForm" method="post">
        <fieldset>
