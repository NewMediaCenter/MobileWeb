...
public class RosterController {
	...
	private static org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(RosterController.class);
	...
	public String getList(HttpServletRequest request, @RequestParam("siteId") String siteId, Model uiModel) {
		try {
			...
			List<SakaiRoster> roster = sakaiRosterService.findCourseRoster(json);
