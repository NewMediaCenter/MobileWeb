...
@Controller
@RequestMapping("/sakaiforumsmessages")
public class ForumsMessagesController {
	
	private static org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(ForumsMessagesController.class);
	...
	public String getCreateJsp(Model uiModel) {
		return "sakaiforums/forumsthreadcreate";
	}

	@RequestMapping(method = RequestMethod.GET)
	public String getList(HttpServletRequest request, @RequestParam("siteId") String siteId, @RequestParam("topicId") String topicId, @RequestParam("topicTitle") String topicTitle, @RequestParam("forumId") String forumId, Model uiModel) {
		try {
		...
		return "sakaiforums/forumsmessages";
	}
